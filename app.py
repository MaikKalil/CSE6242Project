...
def login():
   ...
   if email and '@' in email:
       text_default = ''
       default_selected = {'zip_pref': '10', 'degree_pref': '10'}
...
def update():
    ...
    return render_template('landing.html', user =user, default_value =default_value, default_selected= default_selected,
